    ...
    return (
        <div className="bg-gradient-to-r from-gray-950 via-gray-900 to-gray-950 text-white min-h-screen flex flex-col items-center justify-start">
            ...
            <div className="w-full h-[60vh] relative top-0 flex flex-col">
                <h1 className="pt-8 z-40 opacity-85 title text-4xl sm:text-4xl lg:text-5xl font-extrabold text-white text-center py-6 px-4 bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 shadow-lg">Countdown For Your Upcoming Movies</h1>
                ...
                <div className="mt-96 search-section z-20 flex flex-col items-center justify-center mb-6">
                    <form
                        ...
                        className="flex flex-col sm:flex-row items-center w-full max-w-lg gap-4 px-4"
                    >
                        <div className=''>
                            <input
                                type="text"
